...
{
    'name': "France - FEC Import inheritance without importing partners",
    ...
    'version': '16.0.0.1',
    "depends": ["account_accountant", "base_vat", "l10n_fr", "l10n_fr_fec", "account_base_import", "l10n_fr_fec_import"],
    'license': 'OEEL-1',
    'assets': {
        'web.assets_backend': [
